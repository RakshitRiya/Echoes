...
public class AnimalsCardCategory extends AppCompatActivity {

    // 0 - 20 animals //
    // 21 - 38 fruits //
    String[] strings = {"buffalo", "cat", "monkey"};
    Button ok;
    EditText input_val;
...
//        hint = (TextView)findViewById(R.id.hint);
    ...
    void hello()
    {
       ...
       final int index = (int) (Math.random() * strings.length); //generating random index between 0 to length of input strings array //
        ...
        switch (index) {
            case 0:
                videoId = getResources().getIdentifier("buffalo", "raw", getPackageName());
                break;
            case 1:
                videoId = getResources().getIdentifier("cat", "raw", getPackageName());
                break;
            case 2:
                ...
                videoview.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    public void onCompletion(MediaPlayer mp) {
                        ...
                        if (!gravityView.deviceSupported()) {
                            ...
                            Toast.makeText(AnimalsCardCategory.this, "Device not Supported!!", Toast.LENGTH_SHORT);
                        } else {
...
//            hint.setText("Fruit");
                        ...
                        for (int i = 0; i < selected_string.length(); i++) {
                            ...
                            final TextView rowTextView = new TextView(AnimalsCardCategory.this);
                            String vowel = "aeiou";
                        ...
                        ok.setOnClickListener(new Button.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                try {
                                    ...
                                    {
                                        Toast.makeText(AnimalsCardCategory.this, "Enter any character and then press OK", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                    if (used_characters.contains(entered)) {
                                        Toast.makeText(AnimalsCardCategory.this, "USED", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                    ...
                                    if (successfull_attempts == selected_string.length()) {
                                        ...
                                        if(flag<3)
                                        {
                                            ...
                                            Intent i = new Intent(AnimalsCardCategory.this, AnimalsCardCategory.class);
                                        ...
                                        {
                                            Intent i = new Intent(AnimalsCardCategory.this, Game2End.class);
                                            i.putExtra("game_report", "Congratulations You have \n\t Won");
                                            startActivity(i);finish();
                                        }
                                    ...
                                    // do something //
                                    Toast.makeText(AnimalsCardCategory.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
